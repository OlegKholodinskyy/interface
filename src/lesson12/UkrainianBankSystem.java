...
public class UkrainianBankSystem implements BankSystem {
    ...
    public void transferMoney(User fromUser, User toUser, int amount) {
        ...
        fromUser.setBalance(fromUser.getBalance() - amount - amount * fromUser.getBank().getCommision(amount));
    ...
    public void withdraw(User user, int amount) {
        ...
        user.setBalance(user.getBalance() - amount - amount * user.getBank().getCommision(amount));
    }
    ...
    private boolean checkWithdrawLimits(User user, int amount, double limit) {
        if (amount + user.getBank().getCommision(amount) > limit) {
