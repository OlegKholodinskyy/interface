...
/*
1 - поновлюємо репозиторій з кімнатами
2 - добавляємо в reservedMapRepository дати резервації
3 - добавляємо в orderRepository новий ордер
 */
    public Order addOrder(Order order) throws BadInputException, BadRequestException, ParseException, IOException {
        ...
        roomService.updateRoom(order.getRoom().getId(), order.getDateTo());
    ...
    public void dellOrder(long roomId, long userId) throws BadRequestException, ParseException, IOException {
        ...
        roomService.updateRoom(roomId, new Date());
